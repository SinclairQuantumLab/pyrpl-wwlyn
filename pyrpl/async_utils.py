...
def sleep(delay):
    ...
    # In scripts without an outer qasync runner, use a Qt timer as the
    # completion signal for the shared loop. No asyncio Task may stay on the
    # stack while the loop runs because Python 3.14 rejects task re-entry.
