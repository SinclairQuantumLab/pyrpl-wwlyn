# Fork-derived Z7020 development constraints; not final board timing sign-off.
# Source: sdc/red_pitaya.xdc at 6e76d87. Package mappings remain unchanged.
# Old false paths named clocks that do not exist in this PLL; do not import them.
#
...
# Retain the fork's existing ADC input-delay assumption until board validation.
set_input_delay -clock adc_clk 3.400 [get_ports {adc_dat_a_i[*] adc_dat_b_i[*]}]
# No blanket clock-domain false paths, DAC output-delay guesses or severity waivers.
