...
# Legacy constraint names do not exist in the generated PLL/PS clocks: set_false_path -from [get_clocks adc_clk]     -to [get_clocks dac_clk_out]
# Legacy constraint names do not exist in the generated PLL/PS clocks: set_false_path -from [get_clocks clk_fpga_0]  -to [get_clocks ser_clk_out]
# Legacy constraint names do not exist in the generated PLL/PS clocks: set_false_path -from [get_clocks clk_fpga_0]  -to [get_clocks dac_2clk_out]
set_false_path -from [get_clocks clk_fpga_0]  -to [get_clocks adc_clk]
# Legacy constraint names do not exist in the generated PLL/PS clocks: set_false_path -from [get_clocks clk_fpga_0]  -to [get_clocks par_clk]
# Legacy constraint names do not exist in the generated PLL/PS clocks: set_false_path -from [get_clocks dac_clk_out] -to [get_clocks dac_2clk_out]
# Legacy constraint names do not exist in the generated PLL/PS clocks: set_false_path -from [get_clocks dac_clk_out] -to [get_clocks dac_2ph_out]
