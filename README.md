...
Use the versioned `test.ipynb` for this branch. If it is absent, copy
`test.ipynb.template` to create it and edit its hostname. Preserve existing
notebook settings and results when updating the template.
